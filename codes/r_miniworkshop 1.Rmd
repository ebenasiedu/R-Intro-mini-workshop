...
## Installing R, R studio, and Packages {.tabset}

Please go here: <https://github.com/ebenasiedu/R-Intro-mini-workshop.git>


## Loading Packages {.tabset}

```{r Loading packages, warning=FALSE, message=FALSE}
library(readr)          # for importing csv, tsv, txt, etc files
library(readxl)         # for importing excel files
library(tidyverse)      # includes dplyr, ggplot, and other packages for data tidying and plotting
library(tibble)         # for manipulating data frames
library(ggpubr)         # for plotting and performing statistics
library(viridis)        # for colors compatible with color blindness
library(ggsci)          # for colors suitable for scientific publications
library(reshape2)       # for reshaping data
library(pheatmap)       # for plotting and analyzing heatmaps
library(ComplexHeatmap) # for plotting and analyzing heatmaps
library(patchwork)      # for creating figure panels
library(corrplot)       # for correlation analysis
library(emmeans)        # for summarizing statistical outcomes
...
### Basic manipulation/tidying operations
...
You need a `function` when you copy&paste a code multiple times or use a code to repeat tasks
...
# Lets write a function that takes a set of numbers and tells you their mean
...
## Case Study: analyzing data from scratch {.tabset}
...
## Saving projects and Reporting them {.tabset}
